...
module Strict_comparisons = struct
...
module Equivalence_comparisons = struct
  module For_mach = struct
    let compare_test (t1 : Mach.test) (t2 : Mach.test) : int =
      ...
      | Mach.Iinttest_imm (icomp1, _), Mach.Iinttest_imm (icomp2, _) ->
          Strict_comparisons.For_mach.compare_integer_comparison icomp1
            icomp2
  ...
  module For_cfg = struct
    ...
    let compare_func_call_operation (f1 : Cfg.func_call_operation)
      ...
      | f1, f2 ->
          Strict_comparisons.For_cfg.compare_func_call_operation f1 f2
    ;;
    ...
    let compare_prim_call_operation (f1 : Cfg.prim_call_operation)
      ...
      | f1, f2 ->
          Strict_comparisons.For_cfg.compare_prim_call_operation f1 f2
    ;;
